//! JavaScript bindings for the Together AI provider.
...
#[napi(js_name = "TogetherProvider")]
pub struct JsTogetherProvider {
...
impl JsTogetherProvider {
    ...
    pub fn create(options: Option<JsProviderOptions>) -> Result<Self> {
        ...
        Ok(Self {
            inner: Arc::new(TogetherProvider::from_options(opts).map_err(blazen_error_to_napi)?),
        })
    }
    ...
    pub fn embedding_model(
        ...
        Ok(JsOpenAiCompatEmbeddingModel::wrap(Arc::new(
            OpenAiCompatEmbeddingModel::embedding_from_options("together", opts)

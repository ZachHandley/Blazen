//! JavaScript bindings for the Mistral AI provider.
...
#[napi(js_name = "MistralProvider")]
pub struct JsMistralProvider {
...
impl JsMistralProvider {
    ...
    pub fn create(options: Option<JsProviderOptions>) -> Result<Self> {
        ...
        Ok(Self {
            inner: Arc::new(MistralProvider::from_options(opts).map_err(blazen_error_to_napi)?),
        })
    }

//! JavaScript bindings for the Groq provider.
...
#[napi(js_name = "GroqProvider")]
pub struct JsGroqProvider {
...
impl JsGroqProvider {
    ...
    pub fn create(options: Option<JsProviderOptions>) -> Result<Self> {
        ...
        Ok(Self {
            inner: Arc::new(GroqProvider::from_options(opts).map_err(blazen_error_to_napi)?),
        })
    }

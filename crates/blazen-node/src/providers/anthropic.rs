//! JavaScript bindings for the Anthropic provider.
//!
...
pub struct JsAnthropicProvider {
...
impl JsAnthropicProvider {
    ...
    pub fn create(options: Option<JsProviderOptions>) -> Result<Self> {
        ...
        Ok(Self {
            inner: Arc::new(AnthropicProvider::from_options(opts).map_err(blazen_error_to_napi)?),
        })
    }

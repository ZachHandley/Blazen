//! JavaScript bindings for the xAI (Grok) provider.
...
#[napi(js_name = "XaiProvider")]
pub struct JsXaiProvider {
...
impl JsXaiProvider {
    ...
    pub fn create(options: Option<JsProviderOptions>) -> Result<Self> {
        ...
        Ok(Self {
            inner: Arc::new(XaiProvider::from_options(opts).map_err(blazen_error_to_napi)?),
        })
    }

//! Mistral AI provider.
//!
//! Uses the OpenAI-compatible API at `https://api.mistral.ai/v1`.
...
///
/// Delegates to [`OpenAiCompatProvider`] with the Mistral base URL and
...
///
/// let provider = MistralProvider::new("your-api-key")
...
impl MistralProvider {
    /// Create a new Mistral AI provider with the given API key.
    ///
    ...
    /// Create a new Mistral AI provider with an explicit HTTP client backend.
    #[must_use]
...
super::impl_simple_from_options!(MistralProvider, "mistral", no_base_url);
...
#[async_trait]
impl Model for MistralProvider {
...
#[async_trait]
impl ModelRegistry for MistralProvider {
...
impl crate::providers::root::BaseProvider for MistralProvider {
...
impl crate::providers::capabilities::LLMProvider for MistralProvider {
    async fn complete(
        &self,

...
#[async_trait]
impl Model for FireworksProvider {
...
impl crate::providers::root::BaseProvider for FireworksProvider {
...
impl crate::providers::capabilities::LLMProvider for FireworksProvider {
    async fn complete(
        &self,

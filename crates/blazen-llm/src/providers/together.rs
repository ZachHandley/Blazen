...
#[async_trait]
impl Model for TogetherProvider {
...
impl crate::providers::root::BaseProvider for TogetherProvider {
...
impl crate::providers::capabilities::LLMProvider for TogetherProvider {
    async fn complete(
        &self,

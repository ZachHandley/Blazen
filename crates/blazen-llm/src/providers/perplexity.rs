...
#[async_trait]
impl Model for PerplexityProvider {
...
impl crate::providers::root::BaseProvider for PerplexityProvider {
...
impl crate::providers::capabilities::LLMProvider for PerplexityProvider {
    async fn complete(
        &self,

...
//!
//! `ZAgents` models computation as a directed graph of *steps* connected by
...
pub mod prelude {
    ...
    pub use zagents_events::{AnyEvent, Event, StartEvent, StopEvent};

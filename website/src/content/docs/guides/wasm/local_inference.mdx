...
const apiModel = Model.openrouter(); // reads OPENROUTER_API_KEY
...
```typescript
import init, { Memory, InMemoryBackend, TractEmbedModel, Model, ChatMessage } from '@blazen/sdk';

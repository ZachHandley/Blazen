...
model = CompletionModel.openrouter("sk-or-...", options={"model": "meta-llama/llama-3-70b"})
```
...
|---|---|
| `openai` | `CompletionModel.openai(api_key: str, *, options: dict = None)` |
| `anthropic` | `CompletionModel.anthropic(api_key: str, *, options: dict = None)` |
| `gemini` | `CompletionModel.gemini(api_key: str, *, options: dict = None)` |
| `azure` | `CompletionModel.azure(api_key: str, *, options: dict)` |
| `openrouter` | `CompletionModel.openrouter(api_key: str, *, options: dict = None)` |
| `groq` | `CompletionModel.groq(api_key: str, *, options: dict = None)` |
| `together` | `CompletionModel.together(api_key: str, *, options: dict = None)` |
| `mistral` | `CompletionModel.mistral(api_key: str, *, options: dict = None)` |
| `deepseek` | `CompletionModel.deepseek(api_key: str, *, options: dict = None)` |
| `fireworks` | `CompletionModel.fireworks(api_key: str, *, options: dict = None)` |
| `perplexity` | `CompletionModel.perplexity(api_key: str, *, options: dict = None)` |
| `xai` | `CompletionModel.xai(api_key: str, *, options: dict = None)` |
| `cohere` | `CompletionModel.cohere(api_key: str, *, options: dict = None)` |
| `bedrock` | `CompletionModel.bedrock(api_key: str, *, options: dict)` |
| `fal` | `CompletionModel.fal(api_key: str, *, options: dict = None)` |
